										...
										<div class="table-responsive">
											<table id="table_pats" class="table table-bordered display nowrap " cellspacing="0" width="100%" data-page-size="7">
												<thead>
													<tr>
														<th>#</th>
														<th data-selectable='true'>Ficha </th> <!-- 1 -->
														<th>ID  </th> <!-- 2 -->
														<th>Hospital</th> <!-- 3 -->
														<th data-selectable='true'>Rol estudio</th>
														<th data-selectable='true'>Tipo de control</th>
														<th data-selectable='true'>Diagnóstico ingreso</th><!-- 5 -->
														<th data-selectable='true'>Hallazgo clínico</th><!-- 5 -->
														<th>Fecha ingreso</th> <!-- 6 -->
														<th>Fecha alta</th> <!-- 7 -->
														<th>Edad</th> <!-- 8 -->
														<th data-selectable='true'>Sexo</th> <!-- 9 -->
												...
												<tbody>
													...
													/*
														...
														*
													*/
													 //SELECT * FROM  patients WHERE pat_res_assigned= '$res_id' ORDER BY pat_index DESC
														$ret="SELECT *
																FROM `patients` 
													...
													?>
														...
														<td>
															<div class= "col">
																...
																<a href="his_res_view_single_patient_record.php?pat_id=<?php echo $row['pat_id'];?>&&pat_index=<?php echo $row['pat_index'];?>" class="badge badge-success"><i class="mdi mdi-pencil " style ="font-size:15px;"></i>Ficha</a>
															</div>
															<div class= "col">
																<a href="his_res_view_single_patient.php?pat_id=<?php echo $row['pat_id'];?>&&pat_index=<?php echo $row['pat_index'];?>" class="badge badge-primary"><i class="mdi  mdi-check-box-outline" style ="font-size:15px;" ></i>Días</a>
