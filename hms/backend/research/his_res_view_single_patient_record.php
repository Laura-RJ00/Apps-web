												...
												<div class="container" >
													...
													<div class="holder justify-content-md-center">
														<div class="checkdiv grey400">
															<input type="checkbox" class="le-checkbox" id="ficha_compl" name="ficha_compl" disabled <?php echo $status_checked ?>/>
													 ...
													 <div class="col-md-center">
														<div class="card text-center" style="width: 18rem;">
															...
															<div class="card-footer">
																<button type="button" class="btn btn-primary btn-sm" id="btnCharlson" onclick="getCharlson()" disabled>Calcular</button>
															</div>
														</div>
													</div>
												</div>
