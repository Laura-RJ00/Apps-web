...
<head>
        ...
        <!--This code for injecting an alert-->
                <script>
                            setTimeout(function () 
                            { 
                                Swal.fire("Error","<?php echo $err;?>","Failed");
                            },
                                100);
                </script>
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="post" >
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="email" type="email" id="emailaddress" required="" placeholder="Introduce tu correo">
                                    </div>
