                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <!--<li>
                                        <a href="his_admin_view_patients.php">Ver</a>
                                    </li>-->
                                    <li>
                                        <a href="his_admin_manage_patient.php">Administrar</a>
                                    </li>
                                    <hr>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_add_employee.php">Añadir usuario</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_employee.php">Administrar usuarios</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_admin_add_pharmaceuticals.php">Añadir Entidad</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_pharmaceuticals.php">Administrar Entidades</a>
                                    </li>
                           ...
                           <!-- <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_admin_employee_records.php">Informes de usuarios</a>
                                    </li>
                                   <!-- <li>
                            ...
                            <li>
                                <a href="javascript: void(0);">
                                    ...
                                    <span> Reseteos de contraseña</span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
