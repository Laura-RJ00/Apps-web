                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM patients WHERE pat_role ='Caso' ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Casos</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM user_docs ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Doctores/as</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                     ...
                                                     */ 
                                                    $result ="SELECT count(*) FROM user_research ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Investigadores/as</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                     ...
                                                     */ 
                                                    $result ="SELECT count(*) FROM hospital_docs ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Hospitales colaboradores</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                        ...
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <?php
                                                $ret="SELECT * FROM `users` 
														LEFT JOIN `users_roles` ON `rol_id`= `user_rol`
														LEFT JOIN `user_docs` ON `doc_id`= `user_id`
														LEFT JOIN `user_research` ON `res_id`= `user_id`
