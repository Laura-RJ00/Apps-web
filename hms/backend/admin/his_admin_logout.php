...
<head>
        <meta charset="utf-8" />
        <title>Hospital Management System of Sepis </title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="A fully featured admin theme which can be used to build CRM, CMS, etc." name="description" />
        <meta content="Coderthemes" name="author:Laura Romero Jaque" />
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-muted font-13"> Has cerrado sesión. </p>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Volver a <a href="index.php" class="text-white ml-1"><b>Inicia sesión</b></a> o <a href="../../index.php" class="text-white ml-1"><b>Página de Inicio</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
