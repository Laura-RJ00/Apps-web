                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-muted font-13"> Has cerrado sesión exitosamente. </p>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Volver a <a href="index.php" class="text-white ml-1"><b>Iniciar sesión </b></a> o <a href="../../index.php" class="text-white ml-1"><b>Pagina de inicio</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
