											...
											box-shadow: 0 0 10px #666; background:#e1f5fe">
												...
												<div class="form-row">
													...
													<div class="col-md">
														...
														<input type="text" name="pat_SIP" class="form-control" id="pat_SIP" value="<?php echo $row->pat_sip;?>" readonly>
														
													</div>
													<div class="col-md">
														<label for="pat_NHC" class="col-form-label">NHC </label>
														<input type="text" name="pat_NHC" class="form-control"  id="pat_NHC" value="<?php echo $row->pat_nhc;?>" readonly>
							...
							<form action="" method="post" name= "registration" id="registration" >
								<nav>
									<div class="nav nav-pills nav-fill" id="nav-tab" role="tablist">
										  ...
										  <a class="nav-link" id="step5-tab" data-bs-toggle="tab" href="#step5" onclick="save()">Seguimiento</a>
										  <a class="nav-link" id="step6-tab" data-bs-toggle="tab" href="#step6">Finalizar registro</a>
									...
									<div class="tab-pane fade" id="step4" role="tabpanel" aria-labelledby="step4-tab"> <!-- TTO -->
										...
										?>
											<legend class="float-none w-auto" style ="font-size:20px;">Tratamientos</legend>
												...
												<br></br>
													<button class="eliminarDia btn btn-danger" data-id= "1" >&times; Eliminar </button>
		...
		$.ajax({
			...
			success: function(response) {
				...
				res.datos.forEach(function(dato) {
					  ...
					  html += '  </fieldset>';
					  html += '</div>';
					  html += '<button class="eliminarDia btn btn-danger" data-id= "' + id_dia + '" >&times; Eliminar </button>';
					  html += '</div>';
					  html += '<br>';
			 ...
			 $.ajax({
				...
				success:function(response){
					...
					if (res.success == true){
						...
						console.log('Tratamientos error')
