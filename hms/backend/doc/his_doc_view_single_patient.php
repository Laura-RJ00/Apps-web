                            ...
                            <div class="col-lg-4 col-xl-4">
									...
									<div id="datos_paciente" style ="display:none">
										<div class="card card-body">
											<div class="text-left mt-3">
												...
												<p class="text-muted mb-2 font-13"><strong>SIP:</strong> <span class="ml-2"><?php echo $row->pat_sip;?></span></p>
												<p class="text-muted mb-2 font-13"><strong>Nº de historia clínica:</strong> <span class="ml-2"><?php echo $row->pat_nhc;?></span></p>
												<hr>
												...
												<fieldset class="border p-2">
														...
														<legend class="float-none w-auto" style ="font-size:20px;"> Otros días preUCI recuperados </legend>
														   <b><span class="title">Selecciona el dia de toma de datos</span> </b>
															...
															<br></br>
														<fieldset class="border p-2">
														<legend class="float-none w-auto" style ="font-size:20px;">Nuevo día preUCI personalizado </legend>
														   <b><span class="title">Puedes introducir otro día distinto a los mostrados</span> </b>
															<div class="d-grid gap-2">
																	
																<div class="form-inline well">
																	<div class="form-group" style="width:80%;">
																		<button type="button" class="boton_dia btn-action btn-info btn-lg col-12" style="margin:10px;" name="btndiaOtro_preuci" id="btndiaOtro_preuci" 
																		onclick="ajustar_campos('Dia personalizado','diaOtro_estado','#26a69a','btndiaOtro_preuci','preUCI')">Otro</button>
																	</div>
																</div>
															</div>
														</fieldset>
												...
												<fieldset class="border p-2">
														...
														<legend class="float-none w-auto" style ="font-size:20px;"> Otros días de estudio recuperados </legend>
														   <b><span class="title">Selecciona el dia de toma de datos</span> </b>
															...
															<br></br>
														<fieldset class="border p-2">
														<legend class="float-none w-auto" style ="font-size:20px;">Nuevo día de estudio personalizado </legend>
														   <b><span class="title">Puedes introducir otro día distinto a los mostrados</span> </b>
															<div class="d-grid gap-2">
																	
																<div class="form-inline well">
																	<div class="form-group" style="width:80%;">
																		<button type="button" class="boton_dia btn-action btn-info btn-lg col-12" style="margin:10px;" name="btndiaOtro" id="btndiaOtro" 
																		onclick="ajustar_campos('Dia personalizado','diaOtro_estado','#455a64','btndiaOtro','estudio')">Otro</button>
																	</div>
																</div>
															</div>
														</fieldset>
								...
								<div class="card-box">
									<div class="text-center">
										...
										<button type="button" class="btn btn-success btn-lg" style="width:200px;" id="guardar_dia" onclick="save()">Guardar día</button>
									</div>
								</div>
