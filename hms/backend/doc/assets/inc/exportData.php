...
if (isset($_POST['formData'])) {
    ...
    if (isset($formData['doc_id'], $formData['columnData'])) {
        ...
        if (is_array($columnData)) {
            ...
            // Preparar y ejecutar la consulta SQL con el valor de pat_id y doc_id
            ...
            $rc = $stmt_hist->bind_param('s', $doc_id);
            $stmt_hist->execute();
        } else {
            $response['success'] = true;
        ...
        $response['message'] = 'Datos faltantes para exportar doc_id y columnData.';
    }
} else {
